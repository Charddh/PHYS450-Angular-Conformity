...
if show_ef_amp == 1:
    ...
    ax.errorbar(filtered_r200_ef[mask_filtered_ef], filtered_ef_amp[mask_filtered_ef], yerr=filtered_ef_err[mask_filtered_ef], marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(np.array(r200_list)[mask_unfiltered_ef], np.array(ef_amp)[mask_unfiltered_ef], yerr=np.array(ef_err_list)[mask_unfiltered_ef], marker='o', linestyle='none', color="purple", label="Star-Forming Fraction Amplitude", capsize=2)    
...
if show_eq_amp == 1:
    fig, ax = plt.subplots(1, 1, figsize=(20, 12), constrained_layout=True, dpi=200)
    ax.errorbar(filtered_r200_eq[mask_filtered_eq], filtered_eq_amp[mask_filtered_eq], yerr=filtered_eq_err[mask_filtered_eq], marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(np.array(r200_list)[mask_unfiltered_eq], np.array(eq_amp)[mask_unfiltered_eq], yerr=np.array(eq_err_list)[mask_unfiltered_eq], marker='o', linestyle='none', color="purple", label="Quiescent Fraction Amplitude", capsize=2)    
...
if show_sf_amp == 1:
    ...
    ax.errorbar(filtered_r200, filtered_sf_amp, yerr=filtered_sf_err, marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(r200_list, sf_amp, yerr=sf_err_list, marker='o', linestyle='none', color="purple", label="Star-Forming Fraction Amplitude", capsize=2)
    ax.set_xlabel(r"R/R$_{200}$")
...
if show_sq_amp == 1:
    fig, ax = plt.subplots(1, 1, figsize=(20, 12), constrained_layout=True, dpi=200)
    ax.errorbar(filtered_r200_sq[mask_filtered_sq], filtered_sq_amp[mask_filtered_sq], yerr=filtered_sq_err[mask_filtered_sq], marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(np.array(r200_list)[mask_unfiltered_sq], np.array(sq_amp)[mask_unfiltered_sq], yerr=np.array(sq_err_list)[mask_unfiltered_sq], marker='o', linestyle='none', color="purple", label="Quiescent Fraction Amplitude", capsize=2)    
...
"""if show_q_amp == 1:
    valid_indices = np.where((np.array(q_amp) - np.array(q_err_list_sig)) > 0)
    filtered_r200 = np.array(r200_list)[valid_indices]
    filtered_q_amp = np.array(q_amp)[valid_indices]
    filtered_q_err = np.array(q_err_list_sig)[valid_indices]
    fig, ax = plt.subplots(1, 1, figsize=(20, 12), constrained_layout=True, dpi=200)
    ax.errorbar(filtered_r200, filtered_q_amp, yerr=filtered_q_err, marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(r200_list, q_amp, yerr=q_err_list, marker='o', linestyle='none', color="purple", label="Quiescent Fraction Amplitude", capsize=2)
    ax.set_xlabel(r"R/R$_{200}$")
    ax.set_ylim(0, 3 * max(q_amp))
    ax.set_ylabel("Amplitude of Quiescent Galaxies Fit") 
    ax.legend()
    ax.grid(axis="y", linestyle="--", alpha=0.7)
    plt.show()"""
...
if show_q_amp == 1:
    fig, ax = plt.subplots(1, 1, figsize=(20, 12), constrained_layout=True, dpi=200)
    ax.errorbar(filtered_r200_q[mask_filtered_q], filtered_q_amp[mask_filtered_q], yerr=filtered_q_err[mask_filtered_q], marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(np.array(r200_list)[mask_unfiltered_q], np.array(q_amp)[mask_unfiltered_q], yerr=np.array(q_err_list)[mask_unfiltered_q], marker='o', linestyle='none', color="purple", label="Quiescent Fraction Amplitude", capsize=2)    
    ax.set_ylim(0, 3 * max(q_amp))
    ax.set_xlabel(r"R/R$_{200}$", fontsize=16)
...
if show_f_amp == 1:
    ...
    ax.errorbar(filtered_r200, filtered_f_amp, yerr=filtered_f_err, marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(r200_list, f_amp, yerr=f_err_list, marker='o', linestyle='none', color="purple", label="Star-Forming Fraction Amplitude", capsize=2)
    ax.set_xlabel(r"R/R$_{200}$")
    ax.tick_params(axis='both', which='major', labelsize=16)
    ax.tick_params(axis='both', which='minor', labelsize=16)
...
if show_e_amp == 1:
    ...
    ax.errorbar(filtered_r200, filtered_e_amp, yerr=filtered_e_err, marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(r200_list, e_amp, yerr=e_err_list, marker='o', linestyle='none', color="purple", label="Elliptical Fraction Amplitude", capsize=2)
    ax.set_xlabel(r"R/R$_{200}$")
...
if show_s_amp == 1:
    fig, ax = plt.subplots(1, 1, figsize=(20, 12), constrained_layout=True, dpi=200)
    ax.errorbar(filtered_r200_s[mask_filtered_s], filtered_s_amp[mask_filtered_s], yerr=filtered_s_err[mask_filtered_s], marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(np.array(r200_list)[mask_unfiltered_s], np.array(s_amp)[mask_unfiltered_s], yerr=np.array(s_err_list)[mask_unfiltered_s], marker='o', linestyle='none', color="purple", label="Spiral Fraction Amplitude", capsize=2)    
...
if show_qs_amp == 1:
    fig, ax = plt.subplots(1, 1, figsize=(20, 12), constrained_layout=True, dpi=200)
    ax.errorbar(filtered_r200_qs[mask_filtered_qs], filtered_qs_amp[mask_filtered_qs], yerr=filtered_qs_err[mask_filtered_qs], marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(np.array(r200_list)[mask_unfiltered_qs], np.array(qs_amp)[mask_unfiltered_qs], yerr=np.array(qs_err_list)[mask_unfiltered_qs], marker='o', linestyle='none', color="purple", label="Quiescent Spiral Fraction Amplitude", capsize=2)    
    ax.set_xlabel(r"R/R$_{200}$", fontsize=16)
...
if show_fs_amp == 1:
    fig, ax = plt.subplots(1, 1, figsize=(20, 12), constrained_layout=True, dpi=200)
    ax.errorbar(filtered_r200_fs[mask_filtered_fs], filtered_fs_amp[mask_filtered_fs], yerr=filtered_fs_err[mask_filtered_fs], marker='o', linestyle='none', color="purple", capsize=2, ecolor="black")
    ax.errorbar(np.array(r200_list)[mask_unfiltered_fs], np.array(fs_amp)[mask_unfiltered_fs], yerr=np.array(fs_err_list)[mask_unfiltered_fs], marker='o', linestyle='none', color="purple", label="Star-Forming Spiral Fraction Amplitude", capsize=2)    
    ax.set_xlabel(r"R/R$_{200}$", fontsize=16)
...
if show_combined == 1:
    fig, ax = plt.subplots(1, 1, figsize=(20, 12), constrained_layout=True, dpi=200)
    ax.plot(np.array(r200_list)[mask_unfiltered_sq], np.array(sq_amp)[mask_unfiltered_sq], marker='o', linestyle='-', color="purple", label="Spiral Quiescent Fraction Amplitude")  
    ax.plot(np.array(r200_list)[mask_unfiltered_eq], np.array(eq_amp)[mask_unfiltered_eq], marker='x', linestyle='-', color="blue", label="Elliptical Quiescent Fraction Amplitude")    
    ax.plot(np.array(r200_list)[mask_unfiltered_q], np.array(q_amp)[mask_unfiltered_q], marker='D', linestyle='-', color="orange", label="Quiescent Fraction Amplitude")  
    ax.plot(np.array(r200_list)[mask_unfiltered_qs], np.array(qs_amp)[mask_unfiltered_qs], marker='s', linestyle='-', color="grey", label="Quiescent Spiral Fraction Amplitude")  
    ax.plot(np.array(r200_list)[mask_unfiltered_fs], np.array(fs_amp)[mask_unfiltered_fs], marker='p', linestyle='-', color="red", label="Star-Forming Spiral Fraction Amplitude")  

    ax.tick_params(axis='both', which='major', labelsize=16)
    ax.tick_params(axis='both', which='minor', labelsize=16)
    #ax.plot(r200_list, sq_amp, marker='o', linestyle = '-', color="purple", label="Spiral Quiescent Fraction Amplitude")
    #ax.plot(r200_list, eq_amp, marker='o', linestyle = '-', color="blue", label="Elliptical Quiescent Fraction Amplitude")
    #ax.plot(r200_list, q_amp, marker='o', linestyle = '-', color="orange", label="Quiescent Fraction Amplitude")
    #ax.plot(r200_list, qs_amp, marker='o', linestyle = '-', color="grey", label="Quiescent Spiral Fraction Amplitude")
    #ax.plot(r200_list, fs_amp, marker='o', linestyle = '-', color="yellow", label="Star-Forming Spiral Fraction Amplitude")
    ax.set_xlabel(r"R/R$_{200}$", fontsize=16)
